...
import com.example.fnoteapp.fragments.EditNoteFragmentArgs
...
import com.example.notesroompractice.databinding.FragmentEditBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editNoteFab.setOnClickListener {
            ...
            if (noteTitle.isNotEmpty()) {
                ...
                Toast.makeText(requireContext(), "Please Enter the Note Tittle..", Toast.LENGTH_SHORT).show()
            }
        }
    }
private fun deleteNote(){
    AlertDialog.Builder(requireActivity()).apply{
        ...
        setMessage("Do you want to delete massage?")
